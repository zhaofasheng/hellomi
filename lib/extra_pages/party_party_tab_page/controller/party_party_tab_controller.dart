...
//
// class PartyPartyTabController extends GetxController {
...
//
//     fetchLiveUserModel = await FetchLiveUserApi.callApi(token: token, uid: uid, liveType: ApiParams.audio, country: selectedCountry);
//
