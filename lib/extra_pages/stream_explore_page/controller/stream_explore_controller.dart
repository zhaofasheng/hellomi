...
//
// class StreamExploreController extends GetxController {
...
//
//   List<List<LiveUserList>> liveUsers = [
//     [],
//     [],
//     [],
//     [],
...
//
//     fetchLiveUserModel = await FetchLiveUserApi.callApi(token: token, uid: uid, liveType: ApiParams.explore, country: selectedCountry);
//
