...
import 'package:tingle/page/fake_live_page/widget/fake_viewer_list_tile_widget.dart';
...
class FakeLiveViewerDrawerWidget extends GetView<FakeLiveController> {
  const FakeLiveViewerDrawerWidget({super.key});
            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      '${EnumLocal.txtOnlineAudiences.name.tr} (${controller.fakeLiveModel?.liveViewers.length ?? 0})',
              ...
              Expanded(
                child: GetBuilder<FakeLiveController>(
                  ...
                  builder: (controller) => Container(
                    ...
                    child: (controller.fakeLiveModel?.liveViewers.isEmpty ?? true)
                        ? NoDataFoundWidget(
                            iconSize: 130,
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return FakeViewerUserListTileWidget(index: index, indexData: indexData);
                            },
                          ),
                  ),
                ),
