class FetchRankingRichUserModel {
  FetchRankingRichUserModel({
    bool? status,
    String? message,
    Data? data,
  }) {
  ...
  FetchRankingRichUserModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  String? _message;
  Data? _data;
  FetchRankingRichUserModel copyWith({
    bool? status,
    String? message,
    Data? data,
  }) =>
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    if (json['weekly'] != null) {
      ...
      json['weekly'].forEach((v) {
        _weekly?.add(Daily.fromJson(v));
      });
    }
    if (json['monthly'] != null) {
      _monthly = [];
      json['monthly'].forEach((v) {
        _monthly?.add(Daily.fromJson(v));
      });
    }
  }
  List<Daily>? _daily;
  ...
  List<Daily>? get weekly => _weekly;
  List<Daily>? get monthly => _monthly;
...
//   String? get avtarFrameType => _avtarFrameType;
//   int? get coin => _coin;
//
//   Map<String, dynamic> toJson() {
//     final map = <String, dynamic>{};
