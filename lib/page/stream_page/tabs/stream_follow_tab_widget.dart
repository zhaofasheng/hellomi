                  ...
                  child: SingleChildScrollView(
                    ...
                    child: controller.isLoadingFollow
                        ...
                        : controller.followLiveUsers.isEmpty
                            ...
                            : Column(
                                children: [
                                  _GridWidget(0, (controller.followLiveUsers.length < Utils.bannerShowIndex) ? controller.followLiveUsers.length : Utils.bannerShowIndex),
                                  BannerWidget(
                                    isShow: (controller.followLiveUsers.length > Utils.bannerShowIndex),
                                    margin: EdgeInsets.only(left: 15, right: 15, top: 15, bottom: 15),
                                  ),
                                  Visibility(
                                    visible: (controller.followLiveUsers.length > Utils.bannerShowIndex),
                                    child: _GridWidget(Utils.bannerShowIndex, controller.followLiveUsers.length - Utils.bannerShowIndex),
                                  ),
                                ],
                              ),
                  ),
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final indexData = controller.followLiveUsers[value];
