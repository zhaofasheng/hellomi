                  ...
                  child: SingleChildScrollView(
                    ...
                    child: controller.isLoadingExplore
                        ...
                        : controller.exploreLiveUsers.isEmpty
                            ...
                            : Column(
                                children: [
                                  _GridWidget(0, (controller.exploreLiveUsers.length < Utils.bannerShowIndex) ? controller.exploreLiveUsers.length : Utils.bannerShowIndex),
                                  BannerWidget(
                                    isShow: (controller.exploreLiveUsers.length > Utils.bannerShowIndex),
                                    margin: EdgeInsets.only(left: 15, right: 15, top: 15, bottom: 15),
                                  ),
                                  Visibility(
                                    visible: (controller.exploreLiveUsers.length > Utils.bannerShowIndex),
                                    child: _GridWidget(Utils.bannerShowIndex, controller.exploreLiveUsers.length - Utils.bannerShowIndex),
                                  ),
                                ],
                              ),
                  ),
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final indexData = controller.exploreLiveUsers[value];
