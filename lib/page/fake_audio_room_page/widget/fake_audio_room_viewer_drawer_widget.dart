...
import 'package:tingle/page/fake_audio_room_page/widget/fake_audio_room_viewer_list_tile_widget.dart';
...
class FakeAudioRoomViewerDrawerWidget extends GetView<FakeAudioRoomController> {
  const FakeAudioRoomViewerDrawerWidget({super.key});
            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      '${EnumLocal.txtOnlineAudiences.name.tr} (${controller.fakeAudioRoomModel?.audioRoomSeats.length ?? 0})',
              ...
              Expanded(
                child: GetBuilder<FakeAudioRoomController>(
                  ...
                  builder: (controller) => Container(
                    ...
                    child: (controller.fakeAudioRoomModel?.audioRoomSeats.isEmpty ?? true)
                        ? NoDataFoundWidget(
                            iconSize: 130,
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return FakeAudioRoomViewerUserListTileWidget(index: index, indexData: indexData);
                            },
                          ),
                  ),
                ),
