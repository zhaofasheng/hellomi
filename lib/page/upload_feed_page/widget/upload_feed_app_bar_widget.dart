      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              EnumLocal.txtPostMoments.name.tr,
              ...
              builder: (controller) => GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: controller.selectedImages.isEmpty ? AppColor.lightGrayBg : AppColor.primary,
                    borderRadius: BorderRadius.circular(100),
                  ),
                  child: Text(
                    EnumLocal.txtPost.name.tr,
                    style: AppFontStyle.styleW600(controller.selectedImages.isEmpty ? AppColor.secondary : AppColor.white, 14),
                  ),
                ),
              ),
            ),
