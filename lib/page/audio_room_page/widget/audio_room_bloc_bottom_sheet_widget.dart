...
class AudioRoomBlocBottomSheetWidget {
          ...
          children: [
            ...
            Expanded(
              child: GetBuilder<AudioRoomController>(
                ...
                builder: (controller) => controller.audioRoomModel?.blockUsers.isEmpty ?? true
                    ? NoDataFoundWidget()
                    : SingleChildScrollView(
                        child: ListView.builder(
                          itemCount: controller.audioRoomModel?.blockUsers.length,
                          shrinkWrap: true,
                          physics: NeverScrollableScrollPhysics(),
                          itemBuilder: (context, index) {
                            final indexData = controller.audioRoomModel?.blockUsers[index];
                            return _ItemWidget(
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: Text(
                EnumLocal.txtUnblocked.name.tr,
