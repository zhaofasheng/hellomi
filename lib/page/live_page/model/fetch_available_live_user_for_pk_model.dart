class FetchAvailableLiveUserForPkModel {
  FetchAvailableLiveUserForPkModel({
    bool? status,
    String? message,
  ...
  FetchAvailableLiveUserForPkModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  FetchAvailableLiveUserForPkModel copyWith({
    bool? status,
    String? message,
    List<LiveUserList>? liveUserList,
  }) =>
